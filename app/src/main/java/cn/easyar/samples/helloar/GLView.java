...
public class GLView extends GLSurfaceView
{
    ...
    public GLView(Context context, final ARActivity arActivity)
    {
...
//                LetterDialog letterOpenView = new LetterDialog(mContext);
//                letterOpenView.show();
               ARActivity arActivity1=mARActivity;
               arActivity.letterOpenView.show();
               return;
